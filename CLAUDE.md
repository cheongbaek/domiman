...
(`BAIT_TARGET_PATTERN = r"금.{0,2}지[렁렇령]"` — 260822c에 교체. '갯'은 실측
5/5 전부 오인식이고 '금'이 5/5 살아남는다. 위 260822c 절 참고). 이름 바 8칸을 덮는
...
| `BAIT_TARGET_PATTERN = r"금.{0,2}지[렁렇령]"` | 미끼 카드 탐색 | '갯'은 실측 5/5 전부 오인식(개/켓/것/캠), '금'은 5/5 생존. 옛 `[갯개]지[렁렇령]`은 2/5만 적중해 대상을 놓쳤다. **오인식 종류를 나열하는 방식으로 되돌리지 말 것** — 새 오인식에 또 뚫린다 |
